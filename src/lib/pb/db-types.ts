...
export type MashambaUserResponse = {
  listings?: Array<string>;
} & AuthCollectionRecord;

export type MashambaUserCreate = {
  listings?: MaybeArray<string>;
};

export type MashambaUserUpdate = {
  listings?: MaybeArray<string>;
  "listings+"?: MaybeArray<string>;
  "listings-"?: MaybeArray<string>;
};

export type MashambaUserCollection = {
  type: "auth";
  collectionId: "hrw547uh6z7ysen";
